...
public record StatisticsResponse(String label, Long value) {

    // 시간대별 통계 생성자
    public StatisticsResponse(Integer hour, Long value) {
        this((hour != null) ? hour + "시" : "미지정", value);
    }

    // 리뷰 점수 통계 생성자
    public StatisticsResponse(Double rating, Long value) {
